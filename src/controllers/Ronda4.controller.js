...
export const DineroRonda3 = async (req, res) => {
    try {
        const dinero = await Dinero.find();
        const dineroRonda3 = dinero[2].acumulado;
        res.json({msg: `Dinero De la Ronda 1: ${dineroRonda3}`});
...
export const ResponderPregunta1 = async (req, res) => {
    try {
        const dinero = await Dinero.find();
        let premio = Number(dinero[2].acumulado);
...
export const PremioRonda4 = async (req, res) => {
    try {
