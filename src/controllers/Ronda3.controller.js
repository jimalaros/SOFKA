...
export const DineroRonda2 = async (req, res) => {
    try {
        const dinero = await Dinero.find();
        const dineroRonda2 = dinero[1].acumulado;
        res.json({msg: `Dinero De la Ronda 1: ${dineroRonda2}`});
...
export const ResponderPregunta1 = async (req, res) => {
    try {
        const dinero = await Dinero.find();
        let premio = Number(dinero[1].acumulado);
...
export const PremioRonda3 = async (req, res) => {
    try {
