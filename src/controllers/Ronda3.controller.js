...
/**export const PreguntasRonda3 = async (req, res) => {
    try {
        const PreguntasRonda3 = await Promise.all([
            new Pregunta({ pregunta: 'Por las áreas geográficas que representaban, los bandos opuestos de la Guerra de Secesión eran conocidos como...', categoria: 3 }).save(),
            new Pregunta({ pregunta: '¿Cómo se llamaba la banda cuyo líder era Jim Morrison?', categoria: 3 }).save(),
            new Pregunta({ pregunta: '¿?', categoria: 3 }).save(),
            new Pregunta({ pregunta: 'Perro especial', categoria: 3 }).save(),
            new Pregunta({ pregunta: 'Coca cola', categoria: 3 }).save(),
        ]);
        res.json(PreguntasRonda3);
